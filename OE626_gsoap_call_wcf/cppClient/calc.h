...
//gsoap JR1  service name:	BasicHttpBinding_USCOREICalc 
...
@section CalcService_bindings Service Bindings
  ...
  - @ref BasicHttpBinding_USCOREICalc
...
@page BasicHttpBinding_USCOREICalc Binding "BasicHttpBinding_USCOREICalc"

@section BasicHttpBinding_USCOREICalc_operations Operations of Binding "BasicHttpBinding_USCOREICalc"

  - @ref __JR1__Add

@section BasicHttpBinding_USCOREICalc_ports Endpoints of Binding "BasicHttpBinding_USCOREICalc"
...
/** Operation "__JR1__Add" of service binding "BasicHttpBinding_USCOREICalc".
...
C++ proxy class (defined in soapBasicHttpBinding_USCOREICalcProxy.h):
@code
  class BasicHttpBinding_USCOREICalcProxy;
@endcode
Important: use soapcpp2 option '-j' (or '-i') to generate improved and easy-to-use proxy classes;

C++ service class (defined in soapBasicHttpBinding_USCOREICalcService.h):
@code
  class BasicHttpBinding_USCOREICalcService;
@endcode
...
@section BasicHttpBinding_USCOREICalc_policy_enablers Policy Enablers of Binding "BasicHttpBinding_USCOREICalc"
