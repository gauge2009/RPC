...
#define soap_default_JR3__char(soap, a) soap_default_int(soap, a)

SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__char(struct soap*, const char*, int, const int *, const char*);
SOAP_FMAC3 int * SOAP_FMAC4 soap_in_JR3__char(struct soap*, const char*, int *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_JR3__char(struct soap*, const int *, const char*, const char*);

#ifndef soap_write_JR3__char
#define soap_write_JR3__char(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_JR3__char(soap, data), 0) || soap_put_JR3__char(soap, data, "JR3:char", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 int * SOAP_FMAC4 soap_get_JR3__char(struct soap*, int *, const char*, const char*);

#ifndef soap_read_JR3__char
#define soap_read_JR3__char(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__char(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__guid__(struct soap*, const char*, int, const JR3__guid__ *, const char*);
SOAP_FMAC3 JR3__guid__ * SOAP_FMAC4 soap_in_JR3__guid__(struct soap*, const char*, JR3__guid__ *, const char*);

#ifndef soap_write_JR3__guid__
#define soap_write_JR3__guid__(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "JR3:guid", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 JR3__guid__ * SOAP_FMAC4 soap_get_JR3__guid__(struct soap*, JR3__guid__ *, const char*, const char*);

#ifndef soap_read_JR3__guid__
#define soap_read_JR3__guid__(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__guid__(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 JR3__guid__ * SOAP_FMAC2 soap_instantiate_JR3__guid__(struct soap*, int, const char*, const char*, size_t*);

inline JR3__guid__ * soap_new_JR3__guid__(struct soap *soap, int n = -1) { return soap_instantiate_JR3__guid__(soap, n, NULL, NULL, NULL); }

inline JR3__guid__ * soap_new_req_JR3__guid__(struct soap *soap) { JR3__guid__ *_p = soap_instantiate_JR3__guid__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline JR3__guid__ * soap_new_set_JR3__guid__(struct soap *soap, char *__item, char *__item1) { JR3__guid__ *_p = soap_instantiate_JR3__guid__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->JR3__guid__::__item = __item; _p->xsd__anyType::__item = __item1; } return _p; }

inline void soap_delete_JR3__guid__(struct soap *soap, JR3__guid__ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_JR3__guid__(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_JR3__duration__
#define SOAP_TYPE_JR3__duration__ (53)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__duration__(struct soap*, const char*, int, const JR3__duration__ *, const char*);
SOAP_FMAC3 JR3__duration__ * SOAP_FMAC4 soap_in_JR3__duration__(struct soap*, const char*, JR3__duration__ *, const char*);

#ifndef soap_write_JR3__duration__
#define soap_write_JR3__duration__(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "JR3:duration", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 JR3__duration__ * SOAP_FMAC4 soap_get_JR3__duration__(struct soap*, JR3__duration__ *, const char*, const char*);

#ifndef soap_read_JR3__duration__
#define soap_read_JR3__duration__(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__duration__(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 JR3__duration__ * SOAP_FMAC2 soap_instantiate_JR3__duration__(struct soap*, int, const char*, const char*, size_t*);

inline JR3__duration__ * soap_new_JR3__duration__(struct soap *soap, int n = -1) { return soap_instantiate_JR3__duration__(soap, n, NULL, NULL, NULL); }

inline JR3__duration__ * soap_new_req_JR3__duration__(struct soap *soap) { JR3__duration__ *_p = soap_instantiate_JR3__duration__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline JR3__duration__ * soap_new_set_JR3__duration__(struct soap *soap, char *__item, char *__item1) { JR3__duration__ *_p = soap_instantiate_JR3__duration__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->JR3__duration__::__item = __item; _p->xsd__anyType::__item = __item1; } return _p; }

inline void soap_delete_JR3__duration__(struct soap *soap, JR3__duration__ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_JR3__duration__(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_JR3__char__
#define SOAP_TYPE_JR3__char__ (51)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__char__(struct soap*, const char*, int, const JR3__char__ *, const char*);
SOAP_FMAC3 JR3__char__ * SOAP_FMAC4 soap_in_JR3__char__(struct soap*, const char*, JR3__char__ *, const char*);

#ifndef soap_write_JR3__char__
#define soap_write_JR3__char__(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "JR3:char", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 JR3__char__ * SOAP_FMAC4 soap_get_JR3__char__(struct soap*, JR3__char__ *, const char*, const char*);

#ifndef soap_read_JR3__char__
#define soap_read_JR3__char__(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__char__(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 JR3__char__ * SOAP_FMAC2 soap_instantiate_JR3__char__(struct soap*, int, const char*, const char*, size_t*);

inline JR3__char__ * soap_new_JR3__char__(struct soap *soap, int n = -1) { return soap_instantiate_JR3__char__(soap, n, NULL, NULL, NULL); }

inline JR3__char__ * soap_new_req_JR3__char__(struct soap *soap, int __item) { JR3__char__ *_p = soap_instantiate_JR3__char__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->JR3__char__::__item = __item; } return _p; }

inline JR3__char__ * soap_new_set_JR3__char__(struct soap *soap, int __item, char *__item1) { JR3__char__ *_p = soap_instantiate_JR3__char__(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->JR3__char__::__item = __item; _p->xsd__anyType::__item = __item1; } return _p; }

inline void soap_delete_JR3__char__(struct soap *soap, JR3__char__ *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_JR3__char__(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__JR2__AddResponse
#define SOAP_TYPE__JR2__AddResponse (49)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__JR2__AddResponse(struct soap*, const char*, int, const _JR2__AddResponse *, const char*);
SOAP_FMAC3 _JR2__AddResponse * SOAP_FMAC4 soap_in__JR2__AddResponse(struct soap*, const char*, _JR2__AddResponse *, const char*);

#ifndef soap_write__JR2__AddResponse
#define soap_write__JR2__AddResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "JR2:AddResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _JR2__AddResponse * SOAP_FMAC4 soap_get__JR2__AddResponse(struct soap*, _JR2__AddResponse *, const char*, const char*);

#ifndef soap_read__JR2__AddResponse
#define soap_read__JR2__AddResponse(soap, data) ( soap_begin_recv(soap) || !soap_get__JR2__AddResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _JR2__AddResponse * SOAP_FMAC2 soap_instantiate__JR2__AddResponse(struct soap*, int, const char*, const char*, size_t*);

inline _JR2__AddResponse * soap_new__JR2__AddResponse(struct soap *soap, int n = -1) { return soap_instantiate__JR2__AddResponse(soap, n, NULL, NULL, NULL); }

inline _JR2__AddResponse * soap_new_req__JR2__AddResponse(struct soap *soap) { _JR2__AddResponse *_p = soap_instantiate__JR2__AddResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _JR2__AddResponse * soap_new_set__JR2__AddResponse(struct soap *soap, double *AddResult) { _JR2__AddResponse *_p = soap_instantiate__JR2__AddResponse(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_JR2__AddResponse::AddResult = AddResult; } return _p; }

inline void soap_delete__JR2__AddResponse(struct soap *soap, _JR2__AddResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__JR2__AddResponse(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE__JR2__Add
#define SOAP_TYPE__JR2__Add (48)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out__JR2__Add(struct soap*, const char*, int, const _JR2__Add *, const char*);
SOAP_FMAC3 _JR2__Add * SOAP_FMAC4 soap_in__JR2__Add(struct soap*, const char*, _JR2__Add *, const char*);

#ifndef soap_write__JR2__Add
#define soap_write__JR2__Add(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "JR2:Add", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _JR2__Add * SOAP_FMAC4 soap_get__JR2__Add(struct soap*, _JR2__Add *, const char*, const char*);

#ifndef soap_read__JR2__Add
#define soap_read__JR2__Add(soap, data) ( soap_begin_recv(soap) || !soap_get__JR2__Add(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 _JR2__Add * SOAP_FMAC2 soap_instantiate__JR2__Add(struct soap*, int, const char*, const char*, size_t*);

inline _JR2__Add * soap_new__JR2__Add(struct soap *soap, int n = -1) { return soap_instantiate__JR2__Add(soap, n, NULL, NULL, NULL); }

inline _JR2__Add * soap_new_req__JR2__Add(struct soap *soap) { _JR2__Add *_p = soap_instantiate__JR2__Add(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline _JR2__Add * soap_new_set__JR2__Add(struct soap *soap, double *x, double *y) { _JR2__Add *_p = soap_instantiate__JR2__Add(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->_JR2__Add::x = x; _p->_JR2__Add::y = y; } return _p; }

inline void soap_delete__JR2__Add(struct soap *soap, _JR2__Add *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__JR2__Add(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___wbICalc3__Add(struct soap*, struct __wbICalc3__Add *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___wbICalc3__Add(struct soap*, const struct __wbICalc3__Add *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___wbICalc3__Add(struct soap*, const char*, int, const struct __wbICalc3__Add *, const char*);
SOAP_FMAC3 struct __wbICalc3__Add * SOAP_FMAC4 soap_in___wbICalc3__Add(struct soap*, const char*, struct __wbICalc3__Add *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___wbICalc3__Add(struct soap*, const struct __wbICalc3__Add *, const char*, const char*);

#ifndef soap_write___wbICalc3__Add
#define soap_write___wbICalc3__Add(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___wbICalc3__Add(soap, data), 0) || soap_put___wbICalc3__Add(soap, data, "-wbICalc3:Add", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __wbICalc3__Add * SOAP_FMAC4 soap_get___wbICalc3__Add(struct soap*, struct __wbICalc3__Add *, const char*, const char*);

#ifndef soap_read___wbICalc3__Add
#define soap_read___wbICalc3__Add(soap, data) ( soap_begin_recv(soap) || !soap_get___wbICalc3__Add(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __wbICalc3__Add * SOAP_FMAC2 soap_instantiate___wbICalc3__Add(struct soap*, int, const char*, const char*, size_t*);

inline struct __wbICalc3__Add * soap_new___wbICalc3__Add(struct soap *soap, int n = -1) { return soap_instantiate___wbICalc3__Add(soap, n, NULL, NULL, NULL); }

inline struct __wbICalc3__Add * soap_new_req___wbICalc3__Add(struct soap *soap) { struct __wbICalc3__Add *_p = soap_instantiate___wbICalc3__Add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___wbICalc3__Add(soap, _p); } return _p; }

inline struct __wbICalc3__Add * soap_new_set___wbICalc3__Add(struct soap *soap, _JR2__Add *JR2__Add) { struct __wbICalc3__Add *_p = soap_instantiate___wbICalc3__Add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___wbICalc3__Add(soap, _p); _p->JR2__Add = JR2__Add; } return _p; }

inline void soap_delete___wbICalc3__Add(struct soap *soap, struct __wbICalc3__Add *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___wbICalc3__Add(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default___wbICalc2__Add(struct soap*, struct __wbICalc2__Add *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___wbICalc2__Add(struct soap*, const struct __wbICalc2__Add *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___wbICalc2__Add(struct soap*, const char*, int, const struct __wbICalc2__Add *, const char*);
SOAP_FMAC3 struct __wbICalc2__Add * SOAP_FMAC4 soap_in___wbICalc2__Add(struct soap*, const char*, struct __wbICalc2__Add *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put___wbICalc2__Add(struct soap*, const struct __wbICalc2__Add *, const char*, const char*);

#ifndef soap_write___wbICalc2__Add
#define soap_write___wbICalc2__Add(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___wbICalc2__Add(soap, data), 0) || soap_put___wbICalc2__Add(soap, data, "-wbICalc2:Add", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __wbICalc2__Add * SOAP_FMAC4 soap_get___wbICalc2__Add(struct soap*, struct __wbICalc2__Add *, const char*, const char*);

#ifndef soap_read___wbICalc2__Add
#define soap_read___wbICalc2__Add(soap, data) ( soap_begin_recv(soap) || !soap_get___wbICalc2__Add(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct __wbICalc2__Add * SOAP_FMAC2 soap_instantiate___wbICalc2__Add(struct soap*, int, const char*, const char*, size_t*);

inline struct __wbICalc2__Add * soap_new___wbICalc2__Add(struct soap *soap, int n = -1) { return soap_instantiate___wbICalc2__Add(soap, n, NULL, NULL, NULL); }

inline struct __wbICalc2__Add * soap_new_req___wbICalc2__Add(struct soap *soap) { struct __wbICalc2__Add *_p = soap_instantiate___wbICalc2__Add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___wbICalc2__Add(soap, _p); } return _p; }

inline struct __wbICalc2__Add * soap_new_set___wbICalc2__Add(struct soap *soap, _JR2__Add *JR2__Add) { struct __wbICalc2__Add *_p = soap_instantiate___wbICalc2__Add(soap, -1, NULL, NULL, NULL); if (_p) { soap_default___wbICalc2__Add(soap, _p); _p->JR2__Add = JR2__Add; } return _p; }

inline void soap_delete___wbICalc2__Add(struct soap *soap, struct __wbICalc2__Add *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___wbICalc2__Add(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#ifndef SOAP_TYPE_PointerTo_JR2__Add
#define SOAP_TYPE_PointerTo_JR2__Add (57)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_JR2__Add(struct soap*, _JR2__Add *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_JR2__Add(struct soap*, const char *, int, _JR2__Add *const*, const char *);
SOAP_FMAC3 _JR2__Add ** SOAP_FMAC4 soap_in_PointerTo_JR2__Add(struct soap*, const char*, _JR2__Add **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_JR2__Add(struct soap*, _JR2__Add *const*, const char*, const char*);

#ifndef soap_write_PointerTo_JR2__Add
#define soap_write_PointerTo_JR2__Add(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_PointerTo_JR2__Add(soap, data), 0) || soap_put_PointerTo_JR2__Add(soap, data, "JR2:Add", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 _JR2__Add ** SOAP_FMAC4 soap_get_PointerTo_JR2__Add(struct soap*, _JR2__Add **, const char*, const char*);

#ifndef soap_read_PointerTo_JR2__Add
#define soap_read_PointerTo_JR2__Add(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTo_JR2__Add(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_default_JR3__guid(soap, a) soap_default_string(soap, a)

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_JR3__guid(struct soap*, char *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__guid(struct soap*, const char*, int, char*const*, const char*);
SOAP_FMAC3 char * * SOAP_FMAC4 soap_in_JR3__guid(struct soap*, const char*, char **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_JR3__guid(struct soap*, char *const*, const char*, const char*);

#ifndef soap_write_JR3__guid
#define soap_write_JR3__guid(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_JR3__guid(soap, data), 0) || soap_put_JR3__guid(soap, data, "byte", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 char ** SOAP_FMAC4 soap_get_JR3__guid(struct soap*, char **, const char*, const char*);

#ifndef soap_read_JR3__guid
#define soap_read_JR3__guid(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__guid(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
...
#define soap_default_JR3__duration(soap, a) soap_default_string(soap, a)

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_JR3__duration(struct soap*, char *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_JR3__duration(struct soap*, const char*, int, char*const*, const char*);
SOAP_FMAC3 char * * SOAP_FMAC4 soap_in_JR3__duration(struct soap*, const char*, char **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_JR3__duration(struct soap*, char *const*, const char*, const char*);

#ifndef soap_write_JR3__duration
#define soap_write_JR3__duration(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_JR3__duration(soap, data), 0) || soap_put_JR3__duration(soap, data, "byte", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 char ** SOAP_FMAC4 soap_get_JR3__duration(struct soap*, char **, const char*, const char*);

#ifndef soap_read_JR3__duration
#define soap_read_JR3__duration(soap, data) ( soap_begin_recv(soap) || !soap_get_JR3__duration(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
